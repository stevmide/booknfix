...
function customSelect() {
  ...
  const serviceTypes = {
    1: [
      { id: 1, name: 'Normal Wash', price: 20 },
      { id: 2, name: 'Full Wash', price: 30 }
    ],
    2: [
      { id: 3, name: 'House Cleaning', price: 40 },
      { id: 4, name: 'Office Cleaning', price: 50 },
      { id: 5, name: 'Commercial Cleaning', price: 60 }
    ],
    3: [
      { id: 6, name: 'Water Leaks', price: 70 },
      { id: 7, name: 'Drain Repair', price: 80 },
      { id: 8, name: 'Fixture Installation', price: 90 },
      { id: 9, name: 'Other Options', price: 100 }
    ],
    4: [{ id: 10, name: 'Get a Quote', price: 0 }],
    5: [{ id: 11, name: 'Get a Quote', price: 0 }],
    6: [{ id: 12, name: 'Get a Quote', price: 0 }]
  };
  ...
  <div className="">
      ...
      <ul className="list-disc space-y-4">
        <li className="text-gray-700">
          <span className="text-blue-500 font-bold mr-2">Effortless Booking:</span> Say goodbye to endless phone calls and scheduling headaches. Book appointments directly through our app or website.
        </li>
        <li className="text-gray-700">
          <span className="text-blue-500 font-bold mr-2">Reliable Artisans:</span> Our vetted professionals have a proven track record of quality workmanship and customer satisfaction.
        </li>
        <li className="text-gray-700">
          <span className="text-blue-500 font-bold mr-2">Expertise at Your Doorstep:</span> No matter your needs, we have a skilled artisan for the job - plumbing, electrical, furniture assembly, and more!
        </li>
        <li className="text-gray-700">
          <span className="text-blue-500 font-bold mr-2">Efficient Service:</span> Get your projects completed quickly and efficiently, minimizing disruption to your routine.
        </li>
