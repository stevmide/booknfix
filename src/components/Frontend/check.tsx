  ...
  return (
    <>
      ...
      <p>Product Price: {price}</p>
       Add your checkout page content here */}
      ...
      <div className="px-4 pt-8">
        ...
        <div className="mt-8 space-y-3 rounded-lg border bg-white px-2 py-4 sm:px-6">
          <div className="flex flex-col rounded-lg bg-white sm:flex-row">
            <img className="m-2 h-24 w-28 rounded-md border object-cover object-center" src="/img/car-wash.jpg" alt="" />
            <div className="flex w-full flex-col px-4 py-4">
              <span className="font-semibold">Service Type: {name}</span>
              <span className="float-right text-gray-400">Full Cleaning</span>
              <p className="text-lg font-bold">Cost of Service: ₦{price}</p>
            </div>
          </div>
          {/*<div className="flex flex-col rounded-lg bg-white sm:flex-row">
