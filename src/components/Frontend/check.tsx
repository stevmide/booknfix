  ...
  return (
    <>
      ...
      <div className="px-4 pt-8">
        ...
        <p className="text-gray-400">Check your booking and proceed to payment .</p>
        <div className="mt-8 space-y-3 rounded-lg border bg-white px-2 py-4 sm:px-6">
          <div className="flex flex-col rounded-lg bg-white sm:flex-row">
            <img className="m-2 h-24 w-28 rounded-md border object-cover object-center" src="/img/checkpic.jpg" alt="" />
            
         
            <div className="flex w-full flex-col px-4 py-4">
              <span className="font-semibold">Service Type: {name}</span>  {/* Displays service type */}
              <span className="float-right text-gray-400">{price}</span>  {/* Displays price */}
              <p className="text-lg font-bold">Cost of Service: ₦{price}</p>  {/* Displays cost with price */}
            </div>
          </div>
      ...
      <div className="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
        ...
        <button className="mt-4 mb-8 w-full rounded-md bg-gray-900 px-6 py-3 font-medium text-white">Make Payment</button>
      </div>
      </div>
