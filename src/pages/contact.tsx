              ...
              <div className="mt-6 space-y-8 md:mt-8 ">
                <p className="flex items-start -mx-2">
                  ...
                  <span className="mx-2 text-gray-700 w-72 ">
                    No. 8 Boboye Street Allen Avenue, Ikeja Lagose
                  </span>
                </p>
                ...
                <p className="flex items-start -mx-2">
                  ...
                  <span className="mx-2 text-gray-700 w-72 ">+2347015703716</span>
                </p>
                ...
                <p className="flex items-start -mx-2">
                  ...
                  <span className="mx-2 text-gray-700 truncate w-72 ">service@booknfix.com</span>
                </p>
              </div>
